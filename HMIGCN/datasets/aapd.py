...
class AAPD(TabularDataset):
    ...
    @classmethod
    def splits(cls, path, train=os.path.join('AFtAPD-all-abstract', 'train.tsv'),
               validation=os.path.join('AFtAPD-all-abstract', 'dev.tsv'),
               test=os.path.join('AFtAPD-all-abstract', 'test.tsv'), **kwargs):
